                     ...
                     sidebarPanel(
                         ...
                         hidden(
                             ...
                             sliderInput(inputId = "delta2_test", label = "Mean difference of gene expression (δ2)",
                                         value = 0.2, min = 0.01, max = 10),
                             sliderInput(inputId = "sigma_test", label = "Standard deviation of gene expression (σ)",
                                         value = 0.2, min = 0.01, max = 10),
        ...
        tabPanel("Calculator for single-cell eQTL",
                 sidebarLayout(
                     sidebarPanel(
                         ...
                         tags$br(),
                         hidden(
                             sliderInput(inputId = "sigma_est", label = "Standard deviation of gene expression (σ)",
                                         value = 0.2, min = 0.01, max = 10),
